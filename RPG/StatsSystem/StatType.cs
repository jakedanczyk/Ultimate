...
public enum StatType
{
    ...
    #region attributes
    //attributes
    Agility = 100, //- change speed and direction
	Balance = 101, //- maintain center of gravity
	Coordination = 102, //- align motion and senses
	Dexterity = 103,//- fine motor control
	Endurance = 104, //- cardio
	Flexibility = 105,//- range of motion
	Reflex = 106,//- reaction time
	Speed = 107,//- max limb and locomotion speed
	Strength = 108,//- max force
	Toughness = 109,// - resistance to damage and tolerance to pain
    ...
    Dodge = 546, //dodging is usually a very effective defense, but has the disadvantage of being relatively slow, and in most situations a change in position
    Block = 549, //using a shield, weapon, or (hopefully armored) body part to meet a blow. Damage to defender is reduced or elminated based on character and item stats. items will take damage
    Parry = 550, //actively redirecting an incoming blow. lower damage to defender and items than a block, but more difficult to perform

    //should turn this into dodge, deflect, absorb, parry so people can specialize...each being naturally suited to pair with light, medium, heavy armor.
    //OffHandWeapon = 551, //not implemented
    Armor = 552,

    Deflect, //presenting body parts at the appropriate angle to incoming attacks can cause them to skip off the target, reducing damage. The properties of the offending weapon and defending armor have a significant effect
    Absorb, //a defender can still minimize damage from an attack that reaches the body by skillfully meeting and yielding to the blow. the heavier and stronger a defender is relative to the attacker the more successful this can be.
    ...
    Sling = 566,
    Atlatl = 567,
    Throwing = 568, //rocks, melee weapons or misc. objects
