...
namespace Urth
{
    ...
    public abstract class DualStatLinker : IDualStatValueChange
    {
        ...
        /// <summary>
        /// The Stats linked to by the stat linker
        /// </summary>
        public Stat LinkedStat_1 { get; private set; }
        public Stat LinkedStat_2 { get; private set; }
        ...
        /// </summary>
        public DualStatLinker(Stat stat_1, Stat stat_2)
        {
            LinkedStat_1 = stat_1;
            LinkedStat_2 = stat_2;
