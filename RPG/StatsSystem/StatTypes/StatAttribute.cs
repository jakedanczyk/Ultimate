...
namespace Urth
{
    ...
    /// <summary>
    /// Stat that inherits from StatModifiable and implements IStatScalable and IStatLinkable.
    /// </summary>
    public class StatAttribute : StatModifiable, IStatScalable, IStatLinkable
    {
        ...
        private List<DualStatLinker> _dualStatLinkers;
        ...
        /// Add a linker to the stat and listen to it's valueChange event
        /// </summary>
        public void AddDualLinker(DualStatLinker dualLinker)
        {
        ...
        public void UpdateDualLinkers()
        {
            ...
            foreach (DualStatLinker dualLink in _dualStatLinkers)
            {
        ...
        public StatAttribute()
        {
            ...
            _dualStatLinkers = new List<DualStatLinker>();
        }
